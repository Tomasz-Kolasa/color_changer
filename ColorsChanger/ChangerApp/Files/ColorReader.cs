        ...
        public void BuildUniqueColorsList()
        {
            ...
            foreach (var file in _filesManager.GetProjectFilesPaths())
            {
                ...
                foreach (Match match in Regex.Matches(content, Hex8Colour.Pattern))
                {
                    ...
                    if (_uniqueColors.Where(c => c.DrawingOrig.Equals(ConvertColor.Hex8ToColor(color))).ToList().Count == 0)
                    {
                ...
                foreach (Match match in Regex.Matches(content, Hex6Colour.Pattern))
                {
                    ...
                    if (_uniqueColors.Where(c => c.DrawingOrig.Equals(ConvertColor.Hex6ToColor(color))).ToList().Count == 0)
                    {
                ...
                foreach (Match match in Regex.Matches(content, RgbaColour.Pattern))
                {
                    ...
                    if (_uniqueColors.Where(c => c.DrawingOrig.Equals(ConvertColor.RgbaToColor(color))).ToList().Count == 0)
                    {
                ...
                foreach (Match match in Regex.Matches(content, RgbColour.Pattern))
                {
                    ...
                    if (_uniqueColors.Where(c => c.DrawingOrig.Equals(ConvertColor.RgbToColor(color))).ToList().Count == 0)
                    {
